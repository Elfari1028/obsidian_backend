# Generated by Django 3.0.5 on 2020-08-16 10:11
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('receiver', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='msg_receiver', to=settings.AUTH_USER_MODEL)),
                ('sender', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='msg_sender', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='File',
            fields=[
                ...
                ('last_user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='last_user', to=settings.AUTH_USER_MODEL)),
                ('t_id', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='account.Team')),
                ('u_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='u_id', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Favorites',
